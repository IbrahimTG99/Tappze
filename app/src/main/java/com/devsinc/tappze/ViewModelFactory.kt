...
class ViewModelFactory: ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T = when(modelClass){
        SignInViewModel::class.java -> SignInViewModel(AuthRepositoryImpl(FirebaseAuth.getInstance()))
        SignUpViewModel::class.java -> SignUpViewModel(AuthRepositoryImpl(FirebaseAuth.getInstance()))
        SettingsViewModel::class.java -> SettingsViewModel(AuthRepositoryImpl(FirebaseAuth.getInstance()))
